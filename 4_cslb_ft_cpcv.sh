...
echo 'Bert Base - Training on configs/fine_tune/cslb_cpcv_top_100k_mscg_and_gkb_config.json' 
python3 fine_tune.py --config_file configs/fine_tune/cslb_cpcv_top_100k_mscg_and_gkb_config.json
