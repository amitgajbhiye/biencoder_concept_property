...
print (f'Number of Properties in the loaded prop pickel : {len(prop_name_emb.get("prop_name_list"))}')
print (f'Number of Properties Embedding in the loaded prop pickel : {len(prop_name_emb.get("prop_transformed_emb"))}')

print (f'Number of Concepts in the loaded con pickel : {len(con_name_emb.get("con_name_list"))}')
print (f'Number of Concepts Embedding in the loaded prop pickel : {len(con_name_emb.get("con_transformed_emb"))}')
