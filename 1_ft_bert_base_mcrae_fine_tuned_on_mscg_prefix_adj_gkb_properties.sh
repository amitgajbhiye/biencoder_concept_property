...
#SBATCH --output=logs/100k_concept_property_split_logs/out_ft_bert_base_mcrae_fine_tuned_on_100k_mscg_8k_prefix_adj_100k_gkb_properties.txt
#SBATCH --error=logs/100k_concept_property_split_logs/err_ft_bert_base_mcrae_fine_tuned_on_100k_mscg_8k_prefix_adj_100k_gkb_properties.txt
